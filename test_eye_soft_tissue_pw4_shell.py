...
def createScene(root):
    ...
    plateMo = plate2dNode.addObject('MechanicalObject', template='Rigid3', position=plateCenterOfMass)
    plate2dNode.addObject('UniformMass', totalMass=0.005)
    plate2dNode.addObject('BilateralLagrangianConstraint', template='Rigid3',
    ...
    # plate2dNode.addObject('TriangularShellForceField', youngModulus=5e3,
    ...
    plateVisu = plate2dNode.addChild('plateVisu')
    plateVisu.addObject('OglModel', src=plateCollision.MeshTopology.getLinkPath())
    plateVisu.addObject('RigidMapping', globalToLocalCoords=True)
