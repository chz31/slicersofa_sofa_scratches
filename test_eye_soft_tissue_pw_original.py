...
def createScene(root):
   ...
   # Creating the falling eyeNode object
    ...
    plateMeshLoaderFine = root.addObject('MeshOBJLoader', name='plateMeshLoaderFine', filename='/home/chi/Documents/orbit_SOFA/soft_tissue-models/right_aligned_plate_sofa.obj', scale=1.0)
