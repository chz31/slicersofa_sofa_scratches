...
def createScene(root):
    ...
    root.addObject('CollisionResponse', responseParams="mu="+str(5.0), name='Response', response='FrictionContactConstraint') #FrictionContactConstraint or PenaltyContact
    ...
    #mesh loader for msh
    meshLoaderCoarse = root.addObject('MeshGmshLoader', name='meshLoaderCoarse', filename='/home/chi/Documents/orbit_SOFA/soft_tissue-models/orbit_soft_tissue_down.msh', scale=1.0)
    ...
    meshLoaderFine = root.addObject('MeshOBJLoader', name='meshLoaderFine', filename='/home/chi/Documents/orbit_SOFA/soft_tissue-models/orbit_soft_tissue_down.obj', scale=1.0)
   ...
   # Creating the falling eyeNode object
    ...
    eyeNode.addObject('BoxROI', name='FixedPoints', template='Rigid3',  position="@MechanicalModel.position", box="0 0 0  -60  -20 100")
    eyeNode.addObject('RestShapeSpringsForceField', name='RestShapeSpringForceField', stiffness=1e6, points="@FixedPoints.indices")
    ...
    orbitLoaderCoarse = root.addObject('MeshGmshLoader', name='orbitLoaderCoarse', filename='/home/chi/Documents/orbit_SOFA/soft_tissue-models/right_orbit_repaired.msh', scale=1.0)
    orbitLoaderFine = root.addObject('MeshOBJLoader', name='orbitLoaderFine', filename='/home/chi/Documents/orbit_SOFA/soft_tissue-models/right_orbit_repaired.obj', scale=1.0)
    ...
    plateCMState = plateKeyControl.addObject('MechanicalObject', name='controllerMO', position=plateCenterOfMass, template='Rigid3')
    ...
    plateMeshLoaderFine = root.addObject('MeshOBJLoader', name='plateMeshLoaderFine', filename='/home/chi/Documents/orbit_SOFA/soft_tissue-models/right_plate_sofa2.obj', scale=1.0)
    ...
    toolCMState = toolController.addObject('MechanicalObject', name='controllerMO', position=scoopCenterOfMass, template='Rigid3')

    root.addObject(ScoopController(name="ScoopController", mstate=toolCMState, delta=0.05))


    # Creating the retraction tool object
    toolMeshLoaderFine = root.addObject('MeshOBJLoader', name='toolMeshLoaderFine', filename='/home/chi/Documents/orbit_SOFA/soft_tissue-models/tool.obj', scale=1.0)
    ...
    toolMo = toolNode.addObject('MechanicalObject', template='Rigid3', name='MechanicalModel', position=scoopCenterOfMass, showObject=True, showObjectScale=1.0)
